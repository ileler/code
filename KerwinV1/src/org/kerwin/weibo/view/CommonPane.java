...
public abstract class CommonPane extends JScrollPane implements Runnable{
	...
	public CommonPane(){
		...
		setBorder(BorderFactory.createMatteBorder(2, 0, 0, 0, Theme.getTransparentColor(100)));
	...
	private void initial(){
		loadLabel = new JLabel(Theme.getLoadingImage(),JLabel.CENTER);
	...
	public void setIsLoading(boolean flag){
		if(loadLabel != null)	loadLabel.setVisible(flag);
	}
