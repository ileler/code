...
public class ImageUtil {
	...
	public static BufferedImage resize(BufferedImage source, int targetW,
		...
		if (type == BufferedImage.TYPE_CUSTOM) {
			...
			WritableRaster raster = cm.createCompatibleWritableRaster(targetW,
					targetH);
			target = new BufferedImage(cm, raster, cm.isAlphaPremultiplied(),
					null);
		} else {
	...
	// }
	//
	// private static void saveSubImage(BufferedImage image, Rectangle
	// subImageBounds, File subImageFile) throws IOException{
	// if(subImageBounds.x < 0 || subImageBounds.y < 0 || subImageBounds.width -
	// subImageBounds.x > image.getWidth() || subImageBounds.height -
	// subImageBounds.y > image.getHeight()){
	// return;
	// }
	...
	// saveImageAsJPG("C:\\Users\\kerwin\\Desktop\\1.jpg",
	// "C:\\Users\\kerwin\\Desktop\\2.jpg", 100, 100, true);
	// }
}
